...
/* ΓöÇΓöÇΓöÇ Product data ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ */
interface Card {
  name: string;
  img: string;
  desc: string;
...
const CARDS: Card[] = [
  {
    ...
    desc: "Heat-treated safety glass, up to 5├ù stronger than annealed glass ΓÇö fragments safely on impact.",
  },
  {
    name: "Tempered Glass",
...
/* ΓöÇΓöÇΓöÇ Stable Fisher-Yates shuffle (seeded) ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ */
...
useEffect(() => {
  ...
  //    (instant, not smooth ΓÇö we don't want GSAP to see an in-between state)
  ...
  return (
    <div className="relative bg-background">
      <style>{`
        /* ΓöÇΓöÇ Mobile styles (Γëñ768px) ΓöÇΓöÇ */
        ...
        /* ΓöÇΓöÇ Desktop styles (>768px) ΓöÇΓöÇ */
        ...
        /* ΓöÇΓöÇ Mobile filter: normal in-flow, scrolls away with the page ΓöÇΓöÇ */
        .mobile-filter-block {
          display: none;
      ...
      <PageHeroSection
        ...
        description="From structural facades to delicate decorative panels ΓÇö all manufactured in Addis Ababa from Grade One float glass."
      ...
      <section id="products-gallery" className="bg-background pb-[600px] md:pb-[800px]">
        ...
        {/* ΓöÇΓöÇ MOBILE ONLY: inline filter bar, scrolls with the page ΓöÇΓöÇ */}
        ...
        {/* ΓöÇΓöÇ Body: grid left, filter right ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ */}
        <div
        ...
        >
          {/* ΓöÇΓöÇ Right sticky filter (desktop only) ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ */}
          <aside
          ...
          {/* ΓöÇΓöÇ Image grid ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ */}
