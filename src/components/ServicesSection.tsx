...
export function ServicesSection() {
  ...
  const dragCursor = typeof document !== "undefined"
    ? createPortal(
        ...
        >
          <svg width="32" height="32" viewBox="0 0 18 18" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
            <polyline points="12 3 5 9 12 15" />
          </svg>
          <span style={{ fontFamily: "var(--font-display)", fontSize: "15px", fontWeight: 700, letterSpacing: "0.2em", textTransform: "uppercase", lineHeight: 1, color: "currentColor" }}>
            DRAG
          </span>
          <svg width="32" height="32" viewBox="0 0 18 18" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
        ...
        <div className="svc-box">
          ...
          <div className="svc-carousel-block">
            ...
            <div className="svc-controls">
              <span style={{ fontFamily: "var(--font-display)", fontSize: "11px", letterSpacing: "0.14em", color: "rgba(0, 0, 0, 1)" }}>
              ...
              <div style={{ display: "flex", gap: "12px" }}>
                <button
                  ...
                  onMouseEnter={(e) => { if (canScrollPrev) (e.currentTarget as HTMLButtonElement).style.background = "#0d9e51"; }}
                  onMouseLeave={(e) => { if (canScrollPrev) (e.currentTarget as HTMLButtonElement).style.background = "#0A7C3F"; }}
                >
                  <svg width="18" height="18" viewBox="0 0 18 18" fill="none" stroke="#ffffff" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                ...
                <button
                  ...
                  onMouseEnter={(e) => { if (canScrollNext) (e.currentTarget as HTMLButtonElement).style.background = "#0d9e51"; }}
                  onMouseLeave={(e) => { if (canScrollNext) (e.currentTarget as HTMLButtonElement).style.background = "#0A7C3F"; }}
                >
                  <svg width="18" height="18" viewBox="0 0 18 18" fill="none" stroke="#ffffff" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                ...
                {(services as readonly string[]).map((service) => {
                  ...
                  return (
                    <Link
                      ...
                      to="/services"
                      draggable={false}
                      style={{ flexShrink: 0, flexBasis: "380px", height: "490px", position: "relative", overflow: "hidden", borderRadius: "2px", display: "block", textDecoration: "none" }}
                    >
                      <img
                        src={img}
                        alt={service}
                        draggable={false}
                        style={{ width: "100%", height: "100%", objectFit: "cover", display: "block", transition: "transform 0.55s cubic-bezier(0.4,0,0.2,1)", pointerEvents: "none" }}
                        onMouseEnter={(e) => { (e.currentTarget as HTMLImageElement).style.transform = "scale(1.05)"; }}
                        onMouseLeave={(e) => { (e.currentTarget as HTMLImageElement).style.transform = "scale(1)"; }}
                      />
                      <div style={{ position: "absolute", inset: 0, background: "linear-gradient(to top, rgba(0,0,0,0.78) 0%, rgba(0,0,0,0.12) 50%, transparent 70%)", pointerEvents: "none" }} />
                      <div style={{ position: "absolute", bottom: 0, left: 0, right: 0, padding: "24px 20px 20px", pointerEvents: "none" }}>
                        <p style={{ fontFamily: "var(--font-display)", fontSize: "9px", fontWeight: 500, textTransform: "uppercase", letterSpacing: "0.22em", color: "rgba(255,255,255,0.5)", marginBottom: "6px" }}>
                          Sorana Glass
                        </p>
                        <h3 style={{ fontFamily: "var(--font-display)", fontSize: "clamp(1.15rem, 1.8vw, 1.5rem)", fontWeight: 600, color: "#ffffff", lineHeight: 1.1, margin: 0, letterSpacing: "-0.01em" }}>
                          {service}
                        </h3>
                      </div>
                    </Link>
            ...
            <div className="svc-progress">
              <div style={{ height: "1px", background: "rgba(255,255,255,0.1)", overflow: "hidden" }}>
                <div style={{ height: "100%", background: "#0A7C3F", width: `${((selectedIndex + 1) / total) * 100}%`, transition: "width 0.4s cubic-bezier(0.4,0,0.2,1)" }} />
              </div>
            </div>
